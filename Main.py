...
class Graph:
    ...
    #fetches the neigbours of the current city
    def getNeighbors(self, v):
        return self.adjacency_list[v]

    # heuristic finds the value of a node within the heuristic dictionary
    def h(self, n):
        H = cityHeuristic
        return H[n]
    ...
    def aStarAlgorithm(self, start_node, stop_node):
        ...
        while len(open_list) > 0:
            ...
            for v in open_list:
                if newNode == None or g[v] + self.h(v) < g[newNode] + self.h(newNode):
                    newNode = v;
            if newNode == None:
            ...
            if newNode == stop_node:
                reconst_path = []

                while parents[newNode] != newNode:
                    reconst_path.append(newNode)
